...
<head>
	...
	<title>SISTEMA DE GESTÃO ESCOLAR| <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">SISTEMA DE GESTAO ESCOLAR</a>
                </div>
              ...
              <li><a href="<?php echo PREPEND_PATH; ?>membership_profile.php"><i class="fa fa-user"></i> <strong>Detalhes do meu perfil</strong> </a></li>
